...
import com.luxshare.sigma.core.exception.TransactionalException;
import com.luxshare.sigma.core.type.SystemCode;
import com.luxshare.sigma.data.entity.${entityName};
