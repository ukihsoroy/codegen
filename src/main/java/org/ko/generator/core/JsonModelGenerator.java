 ...
 */
@Component
public class JsonModelGenerator extends AbstractGenerator {
    ...
    public void executor(String... names) throws Exception {
        for (String name : names) {
            ...
            String entityFileName = path + entityName + "JsonModel.cs";
            ...
            if (StringUtils.isNotEmpty(entityFileName)) {
                ...
                Template template = freemarker.getTemplate(properties.getBackEnd().getJsonModelTemplate());
